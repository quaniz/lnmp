...
case "${Stack}" in
    lnmp)
        Dispaly_Selection
        Run_Logged /root/lnmp-install.log LNMP_Stack
        ;;
    lnmpa)
        Dispaly_Selection
        Run_Logged /root/lnmp-install.log LNMPA_Stack
        ;;
    lamp)
        Dispaly_Selection
        Run_Logged /root/lnmp-install.log LAMP_Stack
        ;;
    nginx)
        Run_Logged /root/nginx-install.log Install_Only_Nginx
        ;;
    db)
        Install_Only_Database
        ;;
    php)
        Run_Logged /root/php-install.log Install_Only_PHP
        ;;
    mphp)
        Install_Multiplephp
        ;;
    *)
        ...
        Echo_Red "Usage: $0 {nginx|db|php|mphp}"
        ;;
esac
